...
<div class="tudo">
        <form class="form" role="form" method="POST" action="{{ url('/registro') }}">
            ...
            <div class="form-group{{ $errors->has('funcao') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="funcao" type="text" class="form-control tam" name="funcao" placeholder="Setor:" value="{{ old('funcao') }}" required>
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" onclick="mostrarSenha()" class="ver" style="margin-left: 550px;"><i class="fas fa-eye"></i></button>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" onclick="mostrarSenha2()" class="ver" style="margin-left: 550px;"><i class="fas fa-eye"></i></button>
                </div>
            </div>
